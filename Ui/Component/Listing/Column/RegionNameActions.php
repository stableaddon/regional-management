...
/**
 * Class RegionNameActions
 *
 * @package Stableaddon\RegionalManagement\Ui\Component\Listing\Column
 */
class RegionNameActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
     * Url path  to edit
     *
     * @var string
     */
    const URL_PATH_EDIT = 'regional_management/region_name/edit';
    /**
     * Url path  to delete
     *
     * @var string
     */
    const URL_PATH_DELETE = 'regional_management/region_name/delete';
