...
class CityActions extends \Magento\Ui\Component\Listing\Columns\Column
{
     ...
     * @var string
     */
    const URL_PATH_EDIT = 'regional_management/city/edit';
    /**
     * Url path  to delete
     *
     * @var string
     */
    const URL_PATH_DELETE = 'regional_management/city/delete';
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => [
                            ...
                            'confirm' => [
                                ...
                                'message' => __('Are you sure you wan\'t to delete the Districts "${ $.$data.default_name }" ?')
                            ]
                        ]
                    ];
                }
