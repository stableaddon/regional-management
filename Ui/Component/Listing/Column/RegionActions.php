...
class RegionActions extends \Magento\Ui\Component\Listing\Columns\Column
{
     ...
     * @var string
     */
    const URL_PATH_EDIT = 'regional_management/region/edit';
    /**
     * Url path  to delete
     *
     * @var string
     */
    const URL_PATH_DELETE = 'regional_management/region/delete';
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => [
                            ...
                            'confirm' => [
                                ...
                                'message' => __('Are you sure you wan\'t to delete the Province "${ $.$data.default_name }" ?')
                            ]
                        ]
                    ];
                }
