 ...
 */
class CityName extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
    /**
     * @var string
     */
     ...
     * @param \Stableaddon\RegionalManagement\Model\ResourceModel\City\CollectionFactory $regionCollection
     */
    public function __construct(
        ...
        CityCollectionFactory $regionCollection
    ...
    )
    {
        ...
        $this->_cityCollection = $regionCollection;
        $this->_cityData = $regionCollection->create()->toOptionArray();
    }
    ...
    {
        return 'directory_region_city_name';
    }
    ...
    protected function saveAndReplaceEntity()
    {
        ...
        while ($bunch = $this->_dataSourceModel->getNextBunch()) {
            ...
            foreach ($bunch as $rowNum => $rowData) {
                ...
                $key = array_search($rowData[self::COUNTRY], array_column($this->_cityData, 'title'));
                if ($key) {
                    $rowTtile = $rowData[self::DEFAULT_NAME];
                    $listTitle[] = $rowTtile;
                    $entityList[$rowTtile][] = [
                        self::COUNTRY => $this->_cityData[$key]['value'],
